...
class EfficientNet03(nn.Module):
    def __init__(self, num_classes=100):
        super(EfficientNet03, self).__init__()
        self.stem_conv = nn.Conv2d(3, 16, kernel_size=3, stride=1, padding=0, bias=False)
        self.stem_bn = nn.BatchNorm2d(16)
        self.blocks = nn.Sequential(
            MBConv(16,16,1,2,2,1,1),
            MBConv(16,16,1,2,2,1,1),
            MBConv(16,16,1,2,2,1,1),
            MBConv(16,24,3,4,2,5,2),
            MBConv(24,24,3,4,3,1,2),            
            MBConv(24,48,3,4,3,2,2),
            MBConv(48,48,3,4,3,1,2),
            MBConv(48,108,3,3,3,2,1)
        )
