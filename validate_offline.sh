...
#python3 -m validate.offline_vali_trainer --validate_epochs 50  --model_path  "saved_model/efficient01.pt.best" --learning_rate 0.025 #61%
python3 -m validate.offline_vali_trainer --validate_epochs 50  --model_path  "saved_model/efficient02.pt.best" --learning_rate 0.025
